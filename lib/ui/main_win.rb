...
###                                                                  ###
    ...
    part_toolbar.append( GetText._("Plane"), "Create a new working plane", "PartToolbar/Plane", Gtk::Image.new('../data/icons/middle/go-bottom_middle.png') ){ $manager.activate_tool('plane', true) }
    part_toolbar.append( Gtk::SeparatorToolItem.new )
